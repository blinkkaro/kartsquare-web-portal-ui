...
const OTPVerification = () => {
    ...
    const schema = yup.object().shape({
        code: yup
            ...
            .min(4, t("codeMin") || "Code must be at least 4 chars"), // Assuming 4 or 6 digits
    });
    ...
    return (
        ...
        >
            <Typography variant="h4" fontWeight="700" mb={2} fontSize={{ xs: "1.5rem", sm: "2rem" }}>
                {t("email_verification") || "Verify Email"}
            </Typography>
            <Typography variant="body1" color="text.secondary" mb={4} fontSize={{ xs: "0.875rem", sm: "1rem" }}>
            ...
            <Box mt={3}>
                <Typography variant="body2" color="text.secondary">
                    ...
                    >
                        {resendTimer > 0 ? `Resend in ${resendTimer}s` : t("resend_otp") || "Resend"}
                    </MuiButton>
                </Typography>
            </Box>

            <Box mt={2}>
                <Link href="/supplier/register" underline="hover" sx={{ fontSize: "0.875rem" }}>
                    Change Email?
                </Link>
            </Box>
        </Box>
