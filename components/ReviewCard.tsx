...
import { Box, Avatar, Typography, Rating, Button, useTheme, Collapse } from "@mui/material";
...
const ReviewCard: React.FC<ReviewCardProps> = ({ review }) => {
    ...
    const reviewText = review.questions_and_answers
        .find((qa) => typeof qa.answer === "string")?.answer as string || "No review text";
    ...
    return (
        ...
        >
            ...
            >
                {expanded ? reviewText : `${reviewText.substring(0, 200)}${reviewText.length > 200 ? "..." : ""}`}
            </Typography>
                    ...
                    {review.questions_and_answers
                        ...
                        .map((qa, index) => (
                            <Box key={index} sx={{ display: "flex", alignItems: "center", gap: 1, mb: 0.5 }}>
                                ...
                                <Rating value={qa.answer as number} readOnly size="small" precision={0.5} />
                            </Box>
                        ))}
                </Box>
            </Collapse>
