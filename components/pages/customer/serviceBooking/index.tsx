...
const CustomerServiceBooking = () => {
  ...
  const [location, setLocation] = useState<"at_provider" | "at_customer">(
    "at_provider",
  );
    ...
    <MainLayout>
        ...
        <Container maxWidth="xl">
          ...
          {success && (
            <Alert severity="success" sx={{ mb: 3 }}>
              {english.booking_created_success}
            </Alert>
          )}
          {error && (
            <Alert
                  ...
                  <DateCalendar
                    ...
                    sx={{
                      ...
                      "& .MuiPickersDay-root": {
                        ...
                        "&.MuiDayCalendar-dayOutsideMonth": {
                          opacity: 0.1,
                        },
                      },
              ...
              {service.have_slots && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {english.duration_min.replace(
                        "{duration}",
                        String(service.service_duration || 60),
                      )}
                    </Typography>
                  </Box>
                  <Box
                  ...
                  >
                    {slotsLoading ? (
                      ...
                      timeSlots.map((slot) => {
                        ...
                        const isPast = slotTime.isBefore(
                          dayjs().add(30, "minute"),
                        );
                          ...
                          <Button
                            ...
                            sx={{
                              ...
                              boxShadow: isSelected
                                ? `0 4px 12px ${COLORS.PRIMARY_PURPLE}40`
                                : "none",
                            }}
                          >
                            {displayTime}
            ...
            <Box>
              ...
              >
                ...
                <FormControl component="fieldset" fullWidth>
                  ...
                  >
                    {((service.service_at_location as any) === "at_customer" ||
                      (service.service_at_location as any) === "AT_CUSTOMER" ||
                      (service.service_at_location as any) === "BOTH") && (
                      <>
                        <FormControlLabel
                          value="at_customer"
                          control={
                            <Radio sx={{ color: COLORS.PRIMARY_PURPLE }} />
                          }
                          label={
                            <Box>
                              ...
                              >
                                {english.service_at_your_location}
                              </Typography>
                            </Box>
                          }
                        />
                    ...
                    {((service.service_at_location as any) === "at_provider" ||
                      (service.service_at_location as any) === "AT_PROVIDER" ||
                      (service.service_at_location as any) === "BOTH") && (
                      <>
                        <FormControlLabel
                          ...
                          label={
                            <Box>
                              <Typography variant="body1" fontWeight={600}>
                                {english.at_service_provider_location}
                              </Typography>
                              <Typography
                                variant="caption"
                                color="text.secondary"
                              >
                                I will visit the provider's location for this
                                service
                              </Typography>
                            </Box>
                          }
                        ...
                        {location === "at_provider" && (
                          <Box sx={{ ml: 4, mt: 2, mb: 2 }}>
                            ...
                            >
                              ...
                              >
                                {service.provider_name?.toUpperCase() ||
                                  "PROVIDER"}{" "}
                                ADDRESS
                              </Typography>
                              ...
                              {service.service_address && (
                                ...
                                >
                                  {service.service_address.city_town},{" "}
                                  {service.service_address.state} -{" "}
                                  {service.service_address.pincode}
                                </Typography>
                              )}
                            </Box>
                          </Box>
      ...
      >
        <DialogContent sx={{ p: 4, textAlign: "center", position: "relative" }}>
          ...
          <Typography
            variant="h4"
            sx={{ fontWeight: 700, color: "#1E1E1E", mb: 1 }}
          >
            ...
            >
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                ...
                >
                  ...
                  {selectedTime &&
                    `${english.at_time} ${dayjs(selectedTime).format("h:mma")}`}
                </Typography>
              </Box>
            </Box>
          )}
