...
import { PRIVACY_POLICY_HTML, PRIVACY_POLICY_LAST_UPDATED } from "@/data/legal/privacyPolicyContent";
  ...
  return (
    <MainLayout>
      <Container maxWidth="lg" sx={{ py: { xs: 3, md: 5 } }}>
        ...
        />
        <Box dangerouslySetInnerHTML={{ __html: PRIVACY_POLICY_HTML }} sx={htmlStyles} />
      </Container>
    </MainLayout>
  );
}
