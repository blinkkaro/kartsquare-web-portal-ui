...
export const productSpecificationSchema = (t: TFunction) =>
  yup.object({
      ...
      .test("is-required", "Required", function (value) {
        ...
        if (!hasValue) {
          return this.createError({
            message: `${product_specifications_name} is required`, // Replaced dynamically later
          });
        }
        return true;
      }),
...
export const productSchema = (t: TFunction) =>
  yup.object({
    ...
    sku_number: yup
      ...
      .trim()
      .max(100, t("valNameMax"))
      .required(t("productSkuRequired")),
    price: yup
      .number()
      .typeError(t("valPriceMin"))
      .positive(t("valPriceMin"))
      .min(0.01, t("valPriceMin"))
      .max(10000000, t("valPriceMax"))
    ...
    product_description: yup
      ...
      .required(t("productDescriptionRequired"))
      .min(10, t("productDescriptionMin")),
    product_images: yup
      .array()
      .required(t("productImagesRequired"))
      .min(1, t("productImagesMin")),
    is_returnable: yup.boolean().required(t("productReturnableRequired")),
    specifications: yup.array().of(productSpecificationSchema(t)).optional(),
