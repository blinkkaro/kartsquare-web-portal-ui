...
import { Phone, CalendarToday, LocationOn, Notes, Collections } from "@mui/icons-material";
                    ...
                    <>
                                ...
                                >
                                    <Box>
                                        ...
                                        <Box sx={{ display: 'flex', gap: 1.5 }}>
                                            ...
                                            <Box sx={{
                                                ...
                                                <Typography variant="caption" sx={{ color: "white", fontWeight: 800 }}>
                                                    {currentBooking.service_location === 'at_customer' ? "At Customer" : "In-Store"}
                                                </Typography>
                                            </Box>
                                        </Box>
                                    </Box>
                                    <Box sx={{ textAlign: 'right' }}>
                                        ...
                                        <Typography variant="h5" sx={{ fontWeight: 900, color: "white" }}>
                                            {initialBooking.currency} {totalAmount.toFixed(0)}
                                        </Typography>
                                    </Box>
                                </Box>
                            </Box>
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{ p: 3, display: "flex", alignItems: "center", gap: 2.5 }}>
                                <Avatar
                                    src={booking?.customer_details?.profile_pic || initialBooking.customer_details?.profile_pic || undefined}
                                ...
                                <Box sx={{ flex: 1 }}>
                                    ...
                                    <Typography sx={{ fontWeight: 900, fontSize: "1.2rem", color: isDark ? "white" : "#0F172A" }}>
                                        {booking ? `${booking.customer_details?.first_name || ""} ${booking.customer_details?.last_name || ""}` : `${initialBooking.customer_details?.first_name || ""} ${initialBooking.customer_details?.last_name || ""}`}
                                    </Typography>
                                </Box>
                                <Box sx={{ display: 'flex', gap: 1 }}>
                                    <IconButton
                                        href={`tel:${booking?.customer_details?.contact_number || initialBooking.customer_details?.contact_number}`}
                            ...
                            <Box sx={{ p: 3, display: 'flex', gap: 2.5 }}>
                                ...
                                <Box>
                                    ...
                                    <Typography sx={{ fontWeight: 800, fontSize: "1rem", mb: 0.8, color: isDark ? "white" : "#1E293B" }}>
                                        {booking?.booking_address?.name || initialBooking.booking_address?.name}
                                    </Typography>
                                    <Typography variant="body2" sx={{ color: "#64748B", lineHeight: 1.8, fontWeight: 500 }}>
                                        {booking?.booking_address?.address || initialBooking.booking_address?.address}
                                        {(booking?.booking_address?.landmark || initialBooking.booking_address?.landmark) && (
                                            <><br /><span style={{ color: "#94A3B8", fontSize: '0.75rem' }}>Landmark:</span> {booking?.booking_address?.landmark || initialBooking.booking_address?.landmark}</>
                                        )}
                                        <br />
                                        {booking?.booking_address?.cityTown || initialBooking.booking_address?.cityTown}, {booking?.booking_address?.state || initialBooking.booking_address?.state} — {booking?.booking_address?.pincode || initialBooking.booking_address?.pincode}
                                    </Typography>
                                </Box>
                            </Box>
                        </Box>
