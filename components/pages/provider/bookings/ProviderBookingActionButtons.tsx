...
import { Visibility, PlayArrow, CheckCircle, Cancel, Check, LockOutlined } from "@mui/icons-material";
import { Dialog, Box, Typography, TextField, Slide, useTheme, IconButton, CircularProgress, Button } from "@mui/material";
...
const ProviderBookingActionButtons: React.FC<ProviderBookingActionButtonsProps> = ({ booking, tabName, onViewDetails }) => {
    ...
    const handleUpdateStatus = async (status: string, otpValue?: string) => {
        setLoading(true);
        try {
            await bookingService.updateBookingStatus(booking.booking_id, status, otpValue);
                ...
                >
                    ...
                    >
                        ...
                        <TextField
                            ...
                            sx={{
                                "& .MuiOutlinedInput-root": {
                                    ...
                                    "&.Mui-focused fieldset": { borderColor: COLORS.PRIMARY_PURPLE, borderWidth: '2px' },
                                    "& input::placeholder": {
                                        fontSize: "0.875rem",
                        ...
                        <Box sx={{ width: '100%', display: 'flex', gap: 2 }}>
                            ...
                            >
                                {loading ? <CircularProgress size={24} color="inherit" /> : t("verify_and_start")}
                            </Button>
                        </Box>
                    </Box>
                </Dialog>
