...
interface ServicePricingOptionsProps {
    ...
    onUpdatePriceItem: (index: number, field: "name" | "price" | "description", value: string) => void;
}
                ...
                >
                    <Paper
                        ...
                        sx={{
                            ...
                            bgcolor: pricingType === "single" ? (isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04) : "transparent",
                            cursor: "pointer",
                            transition: "all 0.2s ease",
                            "&:hover": { borderColor: COLORS.PRIMARY_PURPLE, bgcolor: isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04 },
                        }}
                    ...
                    <Paper
                        ...
                        sx={{
                            ...
                            bgcolor: pricingType === "catalog" ? (isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04) : "transparent",
                            cursor: "pointer",
                            transition: "all 0.2s ease",
                            "&:hover": { borderColor: COLORS.PRIMARY_PURPLE, bgcolor: isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04 },
                        }}
                    ...
                    <Paper
                        ...
                        sx={{
                            ...
                            bgcolor: pricingType === "multiple" ? (isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04) : "transparent",
                            cursor: "pointer",
                            transition: "all 0.2s ease",
                            "&:hover": { borderColor: COLORS.PRIMARY_PURPLE, bgcolor: isDark ? COLORS.PURPLE_ALPHA_10 : COLORS.PURPLE_ALPHA_04 },
                        }}
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                        ...
                        {priceCatalogFileNames.length > 0 && (
                            <>
                                ...
                                <Button size="small" onClick={onClearCatalog} sx={{ alignSelf: "flex-start", color: "text.secondary", textTransform: "none" }}>
