...
const InquiryModal: React.FC<InquiryModalProps> = ({
    ...
    const onSubmit: SubmitHandler<FormData> = async (data) => {
        ...
        try {
            ...
            await axios.post("http://localhost:5800/api/v1/supplier-quotations", payload);
    ...
    return (
        <>
            ...
            <Dialog open={showSuccess} onClose={handleCloseSuccess} maxWidth="xs" fullWidth>
                <DialogContent sx={{ textAlign: "center", py: 4 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                        Your inquiry has been sent to the supplier. They will contact you shortly.
                    </Typography>
                    <Button
                        variant="contained"
                        fullWidth
