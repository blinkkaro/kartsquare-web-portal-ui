...
const DUMMY_PRODUCTS: Product[] = [
  {
    ...
    images: [],
    description: "High performance centrifugal pump for industrial water supply.",
    gst: "18%",
    category: "Machinery",
    categoryId: "1",
    specs: { Power: "5HP", Flow: "500L/min" },
    supplier: { name: "AquaFlow Systems", location: "Pune, Maharashtra", rating: 4.8, reviews: 120, yearEstablished: 2010, gstVerified: true, trustSeal: true, responseRate: "98%", businessType: "Manufacturer", address: "MIDC Chakan" }
  },
  {
    id: "hp-2",
    ...
    images: [],
    description: "High-efficiency monocrystalline solar panels for commercial projects.",
    gst: "5%",
    category: "Electrical",
    categoryId: "2",
    specs: { Wattage: "450W", Efficiency: "21.5%" },
    supplier: { name: "GreenTech Energy", location: "Ahmedabad, Gujarat", rating: 4.7, reviews: 340, yearEstablished: 2015, gstVerified: true, trustSeal: true, responseRate: "92%", businessType: "Wholesaler", address: "GIDC Vatva" }
  },
  {
    id: "hp-3",
    ...
    price: "₹ 88,000",
    unit: "Unit",
    image: "https://images.unsplash.com/photo-1545693356-9da8b6680456?q=80&w=800&auto=format&fit=crop",
    images: [],
    ...
    supplier: { name: "Precision Tools Co.", location: "Ludhiana, Punjab", rating: 4.9, reviews: 85, yearEstablished: 2008, gstVerified: true, trustSeal: true, responseRate: "95%", businessType: "Manufacturer", address: "Focal Point" }
  },
  {
    id: "hp-4",
    ...
    images: [],
    description: "Modular heavy-duty steel racks for efficient warehouse storage.",
    gst: "18%",
    category: "Supplies",
    categoryId: "4",
    specs: { Load: "500kg/Shelf", Material: "Galvanized Steel" },
    supplier: { name: "Logistics Pro Solutions", location: "Chennai, TN", rating: 4.6, reviews: 210, yearEstablished: 2012, gstVerified: true, trustSeal: false, responseRate: "89%", businessType: "Wholesaler", address: "Ambattur Estate" }
  },
  {
    id: "hp-5",
    ...
    price: "₹ 15,800",
    unit: "Piece",
    image: "https://images.unsplash.com/photo-1581093583449-80d009b0b4e2?q=80&w=800&auto=format&fit=crop",
    images: [],
    description: "High-precision digital meter for monitoring hydraulic systems.",
    gst: "18%",
    category: "Electronics",
    categoryId: "5",
    specs: { Accuracy: "±0.5%", Pressure: "400 Bar" },
    supplier: { name: "Precision Controls", location: "Bangalore, Karnataka", rating: 4.9, reviews: 92, yearEstablished: 2018, gstVerified: true, trustSeal: true, responseRate: "99%", businessType: "Manufacturer", address: "Peenya Industrial Area" }
  },
  {
    id: "hp-6",
    ...
    price: "₹ 55,000",
    unit: "Unit",
    image: "https://images.unsplash.com/photo-1620912189865-1e8a33da4c59?q=80&w=800&auto=format&fit=crop",
    images: [],
    description: "Reliable backup power solution for small businesses and sites.",
    gst: "18%",
    category: "Machinery",
    categoryId: "1",
    specs: { Fuel: "Diesel", Output: "5kVA" },
    supplier: { name: "PowerSource Ltd", location: "Gurgaon, Haryana", rating: 4.5, reviews: 156, yearEstablished: 2005, gstVerified: true, trustSeal: true, responseRate: "88%", businessType: "Exporter", address: "Udyog Vihar" }
  },
  {
    id: "hp-7",
    ...
    supplier: { name: "BrightLite Industrial", location: "Kolkata, WB", rating: 4.7, reviews: 230, yearEstablished: 2014, gstVerified: true, trustSeal: false, responseRate: "94%", businessType: "Manufacturer", address: "Salt Lake Sector V" }
  },
  {
    id: "hp-8",
    ...
    supplier: { name: "Fastener Hub", location: "Mumbai, Maharashtra", rating: 4.8, reviews: 412, yearEstablished: 1995, gstVerified: true, trustSeal: true, responseRate: "96%", businessType: "Wholesaler", address: "Kalbadevi" }
  }
];
...
const StoreView: React.FC = () => {
  ...
  const [featuredProducts, setFeaturedProducts] = useState<Product[]>(DUMMY_PRODUCTS);
  ...
  const bannerSlides = [
    ...
    },
    {
      ...
      tag: "WAREHOUSING PRO",
      image: "https://images.unsplash.com/photo-1586528116311-ad86d7c7ce80?q=80&w=1470&auto=format&fit=crop",
    ...
    <Box sx={{
      ...
      <Container maxWidth="xl" sx={{ pt: 4 }}>
            ...
            {bannerSlides.map((slide, index) => (
              <SwiperSlide key={index}>
                ...
                >
                  ...
                  <Box sx={{ p: { xs: 4, md: 6 }, color: 'white', maxWidth: 700, position: 'relative', zIndex: 10 }}>
                    <Typography
                      variant="overline"
                      sx={{
                        letterSpacing: 3,
        ...
        <Box sx={{ mb: 10, textAlign: 'center' }}>
          ...
          >
            Search Across <span style={{ color: COLORS.PRIMARY_PURPLE }}>Global Markets</span>
          </Typography>
          <Typography variant="h6" color="text.secondary" fontWeight={500} sx={{ mb: 5, opacity: 0.7, maxWidth: 600, mx: 'auto' }}>
            Connect with trusted sellers for raw materials, machinery, and finished goods instantly.
          </Typography>
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <Search sx={{ color: COLORS.PRIMARY_PURPLE, fontSize: 32, ml: 1 }} />
                  </InputAdornment>
                ),
                sx: {
                  borderRadius: "24px",
                  ...
                  fontSize: '1.25rem',
                  fontWeight: 500,
                  boxShadow: isDark ? '0 10px 40px rgba(0,0,0,0.3)' : '0 20px 60px rgba(15, 23, 42, 0.08)',
        ...
        <Box sx={{ mb: 10 }}>
          <Box sx={{ mb: 4 }}>
            <Typography variant="h5" fontWeight={800} sx={{ color: isDark ? "text.primary" : "#30263E", letterSpacing: -0.5 }}>
          ...
          <Grid container spacing={2}>
            {(homeData?.categories || []).slice(0, 5).map((cat) => (
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 2.4 }} key={cat.product_category_id}>
                <Paper
                  elevation={0}
                  onClick={() => router.push(`/store/products?category=${cat.product_category_id}`)}
                  sx={{
                    p: 3,
                    borderRadius: 5,
        ...
        <Box sx={{
          mb: 12,
          bgcolor: isDark ? "rgba(94, 24, 233, 0.15)" : "rgba(94, 24, 233, 0.07)",
          p: { xs: 4, md: 8 },
          borderRadius: 8,
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 4 }}>
            ...
            <CommonButton variant="outlined" endIcon={<ArrowForward />} sx={{ borderRadius: 2, fontWeight: 700 }}>View All Products</CommonButton>
          </Box>
          <Grid container spacing={3}>
            {productsLoading ? (
              [1, 2, 3, 4].map(n => (
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} key={n}>
                  <Box sx={{ height: 350, bgcolor: 'rgba(0,0,0,0.05)', borderRadius: 5 }} />
                </Grid>
              ))
            ) : (
                ...
                <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} key={product.id}>
                  ...
                  >
                    ...
                    <CardContent sx={{ pt: 1, px: 3, pb: 3 }}>
                      <Typography variant="caption" sx={{ color: COLORS.PRIMARY_PURPLE, fontWeight: 800, textTransform: 'uppercase', letterSpacing: 1 }}>
                        {product.supplier.businessType}
                      </Typography>
                      <Typography variant="subtitle1" fontWeight={800} noWrap sx={{ mt: 0.5, mb: 1 }}>
                        {product.name}
                      </Typography>
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="h6" fontWeight={900} color={isDark ? COLORS.ACCENT_BLUE_DARK : COLORS.PRIMARY_PURPLE}>
                          {product.price}
                        </Typography>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, bgcolor: 'rgba(5, 150, 105, 0.08)', px: 1, py: 0.3, borderRadius: 1 }}>
                          <Verified sx={{ fontSize: 14, color: '#059669' }} />
                          <Typography variant="caption" sx={{ color: '#059669', fontWeight: 800 }}>Trusted</Typography>
                        </Box>
                      </Box>
                    </CardContent>
                  </Card>
        ...
        <Box sx={{ mb: 10 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 4 }}>
            ...
            <CommonButton variant="text" endIcon={<ArrowForward />} sx={{ fontWeight: 700 }}>Browse Everything</CommonButton>
          </Box>
        ...
        <Grid container spacing={6} sx={{ mt: 15, mb: 10 }}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 5 }}>
              ...
              <Box>
                <Typography variant="h5" fontWeight={900} sx={{ color: isDark ? "text.primary" : "#1e293b", letterSpacing: -0.5 }}>
                  Live Business Activity
                </Typography>
                <Typography variant="body2" color="text.secondary" fontWeight={500}>Real-time updates from our marketplace</Typography>
              </Box>
            </Box>
            ...
            <Box sx={{ position: 'relative', pl: 1 }}>
              ...
              <Stack spacing={4}>
                {[
                  { text: "Rahul from Delhi", sub: "Inquired about Industrial Centrifugal Pump", time: "2 mins ago", type: "inquiry", icon: <Message sx={{ fontSize: 16 }} />, color: "#059669" },
                  { text: "New Catalog Update", sub: "Brand 'Tata Steel' added 50+ new products", time: "1 hour ago", type: "update", icon: <Store sx={{ fontSize: 16 }} />, color: COLORS.PRIMARY_PURPLE },
                  { text: "Logistics Update", sub: "Global Logistics Pro joined as a Premier Supplier", time: "3 hours ago", type: "join", icon: <LocalShipping sx={{ fontSize: 16 }} />, color: "#0284c7" },
                  { text: "International Trade", sub: "Export inquiry received for Solar Panels from Dubai", time: "5 hours ago", type: "export", icon: <Public sx={{ fontSize: 16 }} />, color: "#ea580c" }
                ].map((activity, i) => (
                  <Box key={i} sx={{
                    display: 'flex',
                    gap: 3,
                    ...
                    <Box sx={{
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 0.5 }}>
                        <Typography variant="subtitle1" fontWeight={800} sx={{ color: isDark ? "text.primary" : "#1e293b" }}>
                          {activity.text}
                        </Typography>
                        <Typography variant="caption" sx={{ color: 'text.secondary', fontWeight: 600 }}>
                          {activity.time}
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary" fontWeight={500}>What our global partners say about us</Typography>
              </Box>
            </Box>

            <Stack spacing={4}>
              {[
                { name: "Amit Sharma", role: "Factory Owner, Jaipur", text: "Amazing platform for bulk sourcing. Found reliable suppliers for my factory in less than a day. The verification process is top-notch and builds real trust.", rating: 5, initial: "AS" },
                { name: "Priya Patel", role: "Procurement Head, Jaipur", text: "The verified supplier badge gives a lot of confidence for high-value orders. Highly recommended for those looking for quality machinery.", rating: 5, initial: "PP" },
                { name: "Vikram Singh", role: "Business Consultant, Jaipur", text: "Quick response from the inquiry team. The interface is very intuitive and much better than other platforms I've used previously for my clients.", rating: 4.5, initial: "VS" }
              ].map((review, i) => (
                  ...
                  <Box sx={{ display: 'flex', gap: 2.5, mb: 3 }}>
                    ...
                    <Box sx={{ flex: 1 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <Typography variant="subtitle1" fontWeight={900} sx={{ color: isDark ? "text.primary" : "#1e293b" }}>{review.name}</Typography>
                        <Rating value={review.rating} precision={0.5} readOnly size="small" />
                      </Box>
                      <Typography variant="caption" color="text.secondary" fontWeight={700} sx={{ letterSpacing: 0.5, textTransform: 'uppercase' }}>{review.role}</Typography>
                    </Box>
                  </Box>
        ...
        {!loading && homeData?.brands && homeData.brands.length > 0 && (
          <Box sx={{ mt: 15, mb: 10 }}>
            <Typography variant="h5" fontWeight={800} sx={{ mb: 4, color: isDark ? "text.primary" : "#30263E" }}>
              Top Brands in Store
            </Typography>
            <Grid container spacing={3}>
