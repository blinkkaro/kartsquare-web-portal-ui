...
const ReelComments: React.FC<ReelCommentsProps> = ({ post, open, onClose, isSidebar = false }) => {
                    ...
                    <>
                        {comments.map((comment: any) => (
                            <Box key={comment.id} sx={{ display: "flex", gap: 1.5, mb: 2.5 }}>
                                <Avatar src={comment.user_profile_pic || ""} sx={{ width: 34, height: 34 }} />
                                <Box sx={{ flex: 1 }}>
                                    ...
                                    <ExpandableText text={comment.comment} sx={{ my: 0.2, fontSize: "0.85rem", lineHeight: 1.4 }} />
                                    <Box sx={{ display: "flex", gap: 2, mt: 0.5, opacity: 0.7 }}>
                                        <Typography variant="caption" sx={{ fontWeight: 600 }}>{comment.likes_count || 0} likes</Typography>
                                        <Typography variant="caption" sx={{ fontWeight: 600, cursor: "pointer" }}>Reply</Typography>
                                    </Box>
