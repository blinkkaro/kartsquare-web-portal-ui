...
import { HomeRepairService, LocationOn, Directions } from "@mui/icons-material";
...
interface ServiceDetailsMapProps {
    latitude: number;
    longitude: number;
    providerName?: string;
    height?: string;
...
const ServiceDetailsMap: React.FC<ServiceDetailsMapProps> = ({
    latitude,
    longitude,
    providerName,
    height = "400px",
    ...
    const displayProviderName = providerName || t("service_location");
        ...
        >
            <Paper
                ...
                sx={{
                    ...
                    bgcolor: isDark ? "rgba(94, 24, 233, 0.06)" : "#f5f3ff",
                    display: "flex",
                    alignItems: "center",
                    gap: 2,
                    position: "relative",
            ...
            >
                ...
                >
                    <HomeRepairService sx={{ color: "white", fontSize: 26 }} />
                </Box>
                <Box>
                    <Typography
                        variant="subtitle1"
                    ...
                    >
                        {t("service_provider_location") || "Service Provider Location"}
                    </Typography>
                    <Typography
                        variant="body2"
                        sx={{
                                    ...
                                    >
                                        ...
                                        <Box>
                                            ...
                                            <Typography variant="caption" sx={{ color: COLORS.PRIMARY_PURPLE, fontSize: "0.7rem", fontWeight: 700, display: "flex", alignItems: "center", gap: 0.5, mt: 0.2 }}>
                                                {t("directions") || "Get Directions"} <Directions sx={{ fontSize: 11 }} />
                                            </Typography>
                                        </Box>
                                    </Paper>
                                </Fade>
