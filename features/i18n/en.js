export const english = {
  ...
  home_banner_need_pro: "Need a Pro?",
  home_banner_book_trusted: "Book trusted services instantly.",
  home_banner_shopping: "Shopping?",
  home_banner_discover_goods: "Discover local quality goods.",
  ...
  selectCurrentAddress: "Select Current Address",
  ...
  enter_otp_description:
    "Enter the OTP sent to your Registered number to register your business.",
  ...
  guest_login_subtitle: "Provide your details to explore as a guest.",
  ...
  phoneNumberMin: "Phone number must be at least 8 digits",
  phoneNumberMax: "Phone number must be at most 15 digits",
  ...
  countryMin: "Country must be at least 2 characters",
  countryMax: "Country must be at most 56 characters",
  ...
  joinThousandsBusinessOwners:
    "Join thousands of Indian businesses on KartSquare. When people nearby search for what you offer, your name shows up first.",
  ...
  standOutSubtext:
    "Whether you run a Kirana store, a salon, or offer plumbing services — list your business on KartSquare for free. Stop waiting for footfall and let customers in your city find you easily. No commissions, no middleman.",
  ...
  featureFree: "Free",
  featureFreeDesc: "Create a Digital Dukaan at no cost",
  featureEasy: "Easy",
  featureEasyDesc: "Manage your profile directly from your phone",
  featurePersonalised: "Direct Leads",
  featurePersonalisedDesc: "Get calls and WhatsApps directly. 0% Commission.",
  takeChargeTitle: "Your Digital Identity, Your Rules",
  takeChargeSubtext:
    "Customers today search online before they step out. Make sure your business is the first one they see and trust.",
  addEssentialInfo: "Be Found When They Search",
  addEssentialInfoDesc:
    "When someone nearby searches for 'hardware store' or 'electrician near me', your phone number, shop address, and open hours show up instantly.",
  sharePhotosLogos: "Build Trust With Authentic Photos",
  sharePhotosLogosDesc:
    "People buy from shops they trust. Upload photos of your products, your storefront, or your past work so customers know you are genuine.",
  showWhoYouAre: "List Your Services & Rates",
  showWhoYouAreDesc:
    "Don't lose customers because they didn't know you offered a service. Add your complete catalog and price list for absolute transparency.",
  connectWithCustomersTitle: "Turn One-Time Buyers into Regulars",
  connectWithCustomersSubtext:
    "Share local festive offers, new stock alerts, and updates to keep your neighborhood coming back to you instead of big delivery apps.",
  showWhatYouOfferTitle: "Sell Directly to Your Neighbors",
  showWhatYouOfferSubtext:
    "Convert local searches into loyal customers. No matter what your dhanda is, a free profile brings them to your doorstep without paying hefty marketing fees.",
  acceptOrdersTitle: "Take direct calls and WhatsApp queries",
  acceptOrdersDesc:
    "Stop losing margin to aggregators. Customers find you here, but they pay you directly through UPI or Cash.",
  acceptOrdersLearnMore: "Learn more",
  beFoundForWhatYouSellTitle: "Rank higher in your PIN Code",
  beFoundForWhatYouSellDesc:
    "Add detailed tags for every item you sell or service you provide so you never miss a nearby search.",
  beFoundLearnMore: "Learn more",
  offerYourServicesTitle: "Grow your word-of-mouth online",
  offerYourServicesDesc:
    "Collect positive reviews from happy clients in your area, making it easier for new local neighbors to trust and hire you.",
  offerServicesLearnMore: "Learn more",
  whatSuccessLooksLikeTitle: "Real Indian Businesses. Real Growth.",
  whatSuccessLooksLikeSubtext:
    "Don't just take our word for it. See how local shop owners and freelancers are growing their income with KartSquare.",
  showBestOfBusinessTitle: "Get your business online in 3 simple steps",
  showBestOfBusinessSubtext:
    "No technical skills needed. Claim your free listing, add your details, and start getting calls from customers nearby.",
  stepClaim: "1. Claim Your Free Dukaan",
  stepClaimDesc:
    "Enter your mobile number to create your digital storefront in literally 30 seconds. No passwords to remember.",
  stepPersonalise: "2. Add Details & Photos",
  stepPersonaliseDesc:
    "Upload pictures of your shop or work, add your timings, and list what you sell so locals trust you instantly.",
  ...
  primaryMobile: "Primary Number",
  categoriesServed: "Category Served",
  operatingLocations: "Operating Locations",
  businessType: "Business Type",
  establishmentYear: "Establishment Year",
  storeImages: "Store Images",
  storeInfoUpdated: "Store Info Updated",
  storeInfoUpdatedDesc: "Your store information has been updated successfully.",
  ...
  showNumberInServices: "Show Number In Services",
};
