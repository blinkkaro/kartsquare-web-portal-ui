    ...
    switch (tabs[activeTab]) {
      ...
      case "In Progress":
        filtered = bookings.filter(
          (b) =>
            (b.status === "CONFIRMED" &&
              dayjs(b.booking_at).isBefore(dayjs())) ||
                  ...
                  {filteredBookings.map((booking) => (
                    ...
                    >
                      ...
                      <TableCell sx={cellStyle}>
                        <Box>
                          ...
                          <Typography variant="caption" color="text.secondary">
                            {dayjs(booking.booking_at).format("h:mm a")} -{" "}
                            {dayjs(booking.booking_at)
                              .add(2, "hour")
                              .format("h:mm a")}
                          </Typography>
                        </Box>
                      ...
                      <TableCell sx={cellStyle}>
                        ...
                        >
                          {activeTab === tabs.indexOf("Completed") ||
                          ...
                          <Typography
                            variant="body2"
                            fontWeight={700}
                            sx={{ color: isDark ? "text.primary" : "#374151" }}
                          >
                            {booking.currency}{" "}
