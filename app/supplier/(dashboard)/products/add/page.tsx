...
import { useAddProduct } from "@/hooks/useSupplier";
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={4}>
                        ...
                        <Box mb={2}>
                            ...
                            {/* Ideally a Select dropdown fetching categories */}
                        </Box>

                        <Button fullWidth type="submit" isLoading={addProductMutation.isPending} size="large" sx={{ mt: 2 }}>
                            {t("save")}
                        </Button>
                    </Grid>
                </Grid>
